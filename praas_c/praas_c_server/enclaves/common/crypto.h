...
class Crypto
{
  ...
  public:
    ...
    bool Sign(const uint8_t data[32], uint8_t signature[256]);

    bool verify_signature(const uint8_t* pem_public_key, const uint8_t* signature, const uint8_t* hash_signature_input);
